...
const inputCls = 'w-full bg-gray-50 border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-[#00a8cc] transition-colors';
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
      <div className="text-center space-y-2">
        <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Contact CineBook</h1>
        <p className="text-sm text-gray-500">Have questions about tickets, group bookings, or venue rentals?</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 sm:p-8 rounded-2xl border border-gray-200 space-y-6">
          <h3 className="text-base font-semibold text-gray-900">Cinema Headquarters</h3>
        ...
        <div className="bg-white p-6 sm:p-8 rounded-2xl border border-gray-200">
          {submitted ? (
            <div className="text-center py-10 space-y-3">
              ...
              <h4 className="text-base font-semibold text-gray-900">Message Delivered</h4>
              <p className="text-sm text-gray-500">Our customer team will respond within 2 hours.</p>
            </div>
          ) : (
